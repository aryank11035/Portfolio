    ...
    return (Object.values(projects).map((project,index) => (
        <>
            <div key={project.title} className='w-full flex '>
                <div className={`flex w-full gap-10  p-5 items-center justify-center border border-gray-800   hover:bg-[rgba(255,255,255,0.12)]  duration-400 cursor-pointer flex-col 1000:flex-row
